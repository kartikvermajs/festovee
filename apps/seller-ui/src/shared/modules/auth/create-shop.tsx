    ...
    <div>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <input
          ...
          className="w-full p-2 border border-gray-300 outline-0 rounded-[4xl] mb-1"
          {...register("name", {
        ...
        <label className="block text-gray-700 mb-1">
          Bio (Max 100 words) <span className="text-red-500 font-bold">*</span>
        </label>
        <input
          type="text"
        ...
        <label className="block text-gray-700 mb-1">
          Opening Hours <span className="text-red-500 font-bold">*</span>
        </label>
        <input
          type="text"
